...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<mall> mll = new ArrayList<>();
            ...
            if (menu.startsWith("1")){
                if (tko.size() < 1) {
                    ...
                    for(int i = 0; i < tko.size(); i++){
                        ...
                        String idMall = mall.getIdMall();
                        String namaToko = toko.getnamaToko();
                        String namaMall = mall.getnamaMall();
                        ...
                        System.out.println("Id Mall = " + idMall);
                ...
                String id = "" + tko.size();
                String idMall = "" + mll.size()+1;
                System.out.println("Masukkan Nama Toko = ");
                String nama = br.readLine();
                System.out.println("Masukkan Nama Mall = ");
                String namaMall = br.readLine();
                ...
                toko toko = new toko(id, nama, jenis, tanggalSewa, tanggalAkhir, totalHarga, idMall, namaMall);
                mall mall = new mall(idMall, namaMall);
                tko.add(toko);
                mll.add(mall);
            }
                ...
                if (tko.size() < 1) {
                    ...
                    for (int i = 0; i < tko.size(); i++) {
                        ...
                        if (cari.equals(idToko)) {
                            ...
                            System.out.println("Masukkan Nama Mall = "); String namaMallBaru = br.readLine();
                            mallBaru.setnamaMall(namaMallBaru);

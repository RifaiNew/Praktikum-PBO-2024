...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            System.out.println("5. Diskon Toko");
            ...
            if (menu.startsWith("1")){
                ...
                if (pilih.startsWith("1")) {
                    ...
                    tokoPakaian tokoPakaian = new tokoPakaian(id, nama, lokasiToko, "", daftarProduk, jenisPakaian, ukuranTersedia);
                    ...
                    tokoElektronik tokoElektronik = new tokoElektronik(id, nama, lokasiToko, "", daftarProduk, jenisBarang, Merk);
                ...
                tokoPakaian tokoPakaianInstance = new tokoPakaian("", "", "", "", "", "", "");
                tokoElektronik tokoElektronikInstance = new tokoElektronik("", "", "", "", "", "", "");
                System.out.println("Diskon toko elektronik : " + tokoElektronikInstance.diskon(9.25) + " %");
                System.out.println("Diskon Toko Pakaian : " + tokoPakaianInstance.diskon(10) + " %");
            }
